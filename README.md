...
<p align="center">
    <a href="#">
        <img src="https://img.shields.io/github/actions/workflow/status/JuiceFW/marzban/build.yml?style=flat-square" />
    </a>
    <a href="https://hub.docker.com/r/JuiceFW/marzban" target="_blank">
        <img src="https://img.shields.io/docker/pulls/JuiceFW/marzban?style=flat-square&logo=docker" />
    </a>
    <a href="#">
        <img src="https://img.shields.io/github/license/JuiceFW/marzban?style=flat-square" />
    </a>
    <a href="#">
        <img src="https://img.shields.io/github/stars/JuiceFW/marzban?style=social" />
    </a>
</p>
...
```bash
sudo bash -c "$(curl -sL https://github.com/JuiceFW/Marzban/raw/master/marzban.sh)" @ install
```

Run the following command to install Marzban with MySQL database:

```bash
sudo bash -c "$(curl -sL https://github.com/JuiceFW/Marzban/raw/master/marzban.sh)" @ install --database mysql
```

Run the following command to install Marzban with MariaDB database:
```bash
sudo bash -c "$(curl -sL https://github.com/JuiceFW/Marzban/raw/master/marzban.sh)" @ install --database mariadb
```
...
```bash
git clone https://github.com/JuiceFW/Marzban.git
cd Marzban
...
```bash
sudo bash -c "$(curl -sL https://github.com/JuiceFW/Marzban/raw/master/marzban.sh)" @ install-script
```
...
Check [open issues](https://github.com/JuiceFW/marzban/issues) to help the progress of this project.

<p align="center">
Thanks to the all contributors who have helped improve Marzban:
</p>
<p align="center">
<a href="https://github.com/JuiceFW/Marzban/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=JuiceFW/Marzban" />
</a>
</p>
<p align="center">
